...
// (components/core/morphing-popover.tsx), aside from the RefObject<T | null>
// widening in useClickOutside — a React 19 typing fix already applied
// elsewhere in this codebase (see dialog.tsx / in-view.tsx), not an
...
// `as const` on `type` — otherwise TS widens it to `string`, which isn't
// assignable to Transition's `AnimationGeneratorType` union.
