...
import { Calendar, Camera, Check, MapPin } from "lucide-react";
...
// No real photos yet — Google Drive sync is separate, pending work. Each
// entry stands in with a botanical colour wash where a real photo will
// eventually sit. Drop a `src` onto an entry once real photos are wired up
// and its card switches to a real <img>, no other changes needed.
type GalleryPhoto = {
  id: string;
  caption: string;
  src?: string;
...
const engagementPhotos: GalleryPhoto[] = [
  { id: "1", caption: "The proposal", rotate: -3, aspect: "aspect-[4/5]", from: "#dfe4d7", to: "#9fb29f" },
  { id: "2", caption: "First toast", rotate: 2, aspect: "aspect-square", from: "#ece7dc", to: "#c9bd9e" },
  { id: "3", caption: "Just the two of us", rotate: -2, aspect: "aspect-[5/4]", from: "#c9d6c6", to: "#4c6b52" },
  { id: "4", caption: "The ring", rotate: 3, aspect: "aspect-[3/4]", from: "#f4f1ec", to: "#cfc2a3" },
  { id: "5", caption: "With family", rotate: -1, aspect: "aspect-square", from: "#d8ded2", to: "#7c9482" },
  { id: "6", caption: "More to come", rotate: 2, aspect: "aspect-[4/5]", from: "#ece7dc", to: "#dfd6bd" },
];
...
function GallerySection() {
  return (
    <section className="relative w-full max-w-5xl px-6 py-16">
      ...
      <div className="mt-12 columns-2 gap-5 sm:columns-3">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,1.3fr)] md:items-stretch">
        ...
        >
          <div>
            ...
            <p className="mt-1.5 font-display text-xl text-ink">To be confirmed</p>
          </div>
          ...
          <p className="font-reading text-sm text-ink-soft">
            We&rsquo;ll share exact timing and location as soon as
            they&rsquo;re locked in — RSVP now and we&rsquo;ll keep you
            posted.
          </p>
        </InView>
        ...
        >
          {/* No venue yet, so this shows an illustrative, deliberately
              softened area rather than a precise pin — becomes a real,
              full-colour embed the moment a venue query replaces this one. */}
          <iframe
            src="https://www.google.com/maps?q=London,UK&output=embed"
            className="absolute inset-0 h-full w-full border-0"
            style={{ filter: "grayscale(0.55) sepia(0.12) contrast(1.05)" }}
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
            title="Approximate area — venue to be confirmed"
          />
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0"
            style={{
              background: "linear-gradient(160deg, rgba(76,107,82,0.24) 0%, rgba(35,37,32,0.1) 100%)",
